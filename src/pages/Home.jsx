...
},
{
  ...
  return (
    <div className="relative z-10 max-w-7xl mx-auto px-6 space-y-32 pb-24">
      ...
      {/* SECTION 3: KEY OPERATIONAL HIGHLIGHTS (Double-glow hardware standard mesh) */}
      <div className="grid md:grid-cols-3 gap-8 items-stretch pt-12">
        {/* Card 1: Regional Footprint Matrix */}
      ...
      {/* SECTION 6: AMORTIZED TIED CALCULATOR MODULE (30% Reducing Balance Curve) */}
      <div className="grid md:grid-cols-12 gap-12 items-center bg-emerald-50/40 border border-emerald-100 p-8 md:p-12 rounded-3xl">
        ...
        <div className="md:col-span-7 bg-white p-6 md:p-8 rounded-2xl shadow-xl shadow-emerald-950/5 space-y-6">
          {/* 1. Rigid Loan Amount Radio Node Buttons */}
          ...
          {/* 2. Tenure Slider Bounded strictly between 18 and 24 months */}
          <div className="space-y-2">
          ...
          {/* 3. Mathematical Reducing Interest Output Processing Node */}
          {(() => {
      ...
      {/* SECTION 7: INTERACTIVE ACCORDION FAQS (Redesigned matching image_8464a4.png style specs) */}
